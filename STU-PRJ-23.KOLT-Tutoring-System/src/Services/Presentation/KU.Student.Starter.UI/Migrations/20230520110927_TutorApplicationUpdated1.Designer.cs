...
namespace KU.Student.Starter.UI.Migrations
{
    ...
    [Migration("20230520110927_TutorApplicationUpdated1")]
    partial class TutorApplicationUpdated1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KU.Student.Starter.UI.Models.Period", b =>
                {
                    ...
                    b.HasIndex("Day", "StartHour", "EndHour")
                        .IsUnique()
                        .HasDatabaseName("IX_UniquePeriod");
